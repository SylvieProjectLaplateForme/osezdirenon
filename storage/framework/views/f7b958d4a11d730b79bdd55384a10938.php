...
<section class="bg-pink-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <div class="bg-pink-100 border border-pink-300 text-pink-800 p-4 rounded mt-8 text-center shadow-sm">
            ...
            <a href="<?php echo e(route('editeur.dashboard')); ?>" class="underline font-semibold hover:text-pink-600">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utilisateur\Desktop\blog\resources\views/apropos.blade.php ENDPATH**/ ?>