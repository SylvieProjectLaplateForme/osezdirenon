...
{{-- ✅ Bloc HERO centré — mobile + desktop --}}
<div class="bg-pink-50 p-6 rounded-xl text-center max-w-3xl mx-auto mt-8">

    {{-- TITRE PRINCIPAL — adapté pour mobile/desktop --}}
    ...
    {{-- IMAGE RONDE responsive — réduite sur mobile --}}
...
{{-- ✅ AFFICHAGE DES ARTICLES EN GRILLE responsive --}}
@if ($articles->count())
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($articles as $article)
            {{-- 📰 CARD ARTICLE — responsive et animée --}}
            ...
            {{-- 🎀 Insérer carrousel pub APRÈS le 3e article --}}
            @if ($loop->iteration === 3)
